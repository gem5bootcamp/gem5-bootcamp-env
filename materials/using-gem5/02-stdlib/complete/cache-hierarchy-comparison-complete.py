...
if args.shared_l2:
    ...
    from private_l1_shared_l2_cache_hierarchy.private_l1_shared_l2_cache_complete import PrivateL1SharedL2CacheHierarchy
    cache_hierarchy = PrivateL1SharedL2CacheHierarchy(l1d_size="32KiB", l1i_size="32KiB", l2_size="64KiB")
else:
